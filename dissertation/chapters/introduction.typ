...
tasks despite the recent explosion in the field's popularity. This proposed research paper aims to introduce a memory allocator purpose built for data science tasks and the
...
languages as well as libraries and frameworks but little research is published on the topic.
...
compared to both the default memory allocator on Linux (Ubuntu) and MacOS. The comparison will make use of a number of artificial benchmarks as well as a real world benchmark
