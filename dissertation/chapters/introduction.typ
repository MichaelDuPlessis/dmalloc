...
Custom memory allocators are not a new thing but there is little to no research in developing memory allocators specifically for the field of big data science. This mini-dissertation
...
The results will then be compared and it will be determined whether the field of big data science can benefit from both custom built memory allocators and small object allocators. The allocators will be compared
